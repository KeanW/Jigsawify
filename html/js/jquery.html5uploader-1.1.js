  ...
  $.fn.html5Uploader = function (options) {
      ...
      $dropElement.bind("drop", function (e) {
        ...
        if (files.length > 0) {
          ...
          if (imageUrl) {
            ...
            imageUrl =
              settings.imageUrl + "?url=" + encodeURIComponent(imageUrl);
    ...
    function startProcess(fileOrUrl) {
      var callback = function () {
        ...
        convertCanvasToBlob(canvas, function (blob) {
    ...
    function scaleAndCropImage(img) {
      ...
      var ret = determineCropWidthAndHeight(
        cropRatio,
        originalWidth,
        originalHeight
      );
      ...
      ret = determineScaleWidthAndHeight(
        settings.maxLength,
        cropWidth,
        cropHeight
      );
